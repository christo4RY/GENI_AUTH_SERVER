...
const Verify = () => {
    const { frontend_url } = usePage().props
    ...
    const verify = async (e) => {
        // router.post(route('email.verify'), form.values)
            ...
            <div className="w-full md:w-[50%] flex items-center">
                <div className="w-full">
                    <div className="w-full md:w-[70%] mx-auto p-8 md:p-10">
                        ...
                        <form onSubmit={form.onSubmit(verify)} className="w-full  md:w-[75%] mx-auto flex flex-col items-center justify-center">
                            <TextInput
                                className="w-full"
                                variant="filled"
                                placeholder="email"
